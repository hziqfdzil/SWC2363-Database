...
<body>
   ...
   <div class="banner_bg_main">
      ...
      <div class="logo_section">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <div class="logo"><a href="index.html"><img src="images/logo_shopme-removebg-preview.png"></a></div>
               </div>
            </div>
         </div>
      </div>
         ...
         <?php if (isset($_SESSION['username'])): ?>
            <li>
               <a href="#">
                  ...
                  <span class="padding_10"><?php echo htmlspecialchars($_SESSION['username']); ?></span>
               </a>
            </li>
            <li>
               <a href="logout.php">
            ...
            <div id="my_slider" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="row">
                        <div class="col-sm-12">
                           <h1 class="banner_taital">Get Start <br>Shopping Your Favorite Items</h1>
                  ...
                  <div class="carousel-item">
                     <div class="row">
                        <div class="col-sm-12">
                           <h1 class="banner_taital">Get Start <br>Don't Forget Your Card</h1>
                           <div class="buynow_bt"><a href="#">Buy Now</a></div>
                        </div>
                     </div>
                  </div>
                  <div class="carousel-item">
                     <div class="row">
                        <div class="col-sm-12">
                           <h1 class="banner_taital">Get Start <br>Ready For The New Items</h1>
                           <div class="buynow_bt"><a href="#">Buy Now</a></div>
                        </div>
                     </div>
                  </div>
   ...
   <div class="fashion_section">
      <div id="main_slider" class="carousel slide" data-ride="carousel">
         <div class="carousel-inner">
                     ...
                     <div class="row">
                        <div class="col-lg-4 col-sm-4">
                           <div class="box_main">
                              ...
                              <div class="tshirt_img"><img src="images/kemeja-removebg-preview.png"></div>
                              <div class="btn_main">
                        ...
                        <div class="col-lg-4 col-sm-4">
                           <div class="box_main">
                              ...
                              <p class="price_text">Price <span style="color: #262626;">RM 30</span></p>
                              <div class="tshirt_img"><img src="images/shirt-removebg-preview.png"></div>
                              <div class="btn_main">
                                 <div class="buy_bt"><a href="#">Buy Now</a></div>
                                 <div class="seemore_bt"><a href="#">See More</a></div>
                              </div>
                        ...
                        <div class="col-lg-4 col-sm-4">
                           <div class="box_main">
                              ...
                              <p class="price_text">Price <span style="color: #262626;">RM 30</span></p>
                              <div class="tshirt_img"><img src="images/hoodie-removebg-preview.png"></div>
                              <div class="btn_main">
                                 <div class="buy_bt"><a href="#">Buy Now</a></div>
                                 <div class="seemore_bt"><a href="#">See More</a></div>
                              </div>
            ...
            <div class="carousel-item">
               <div class="container">
                  <h1 class="fashion_taital">Kid Fashion</h1>
                  <div class="fashion_section_2">
                     <div class="row">
                        <div class="col-lg-4 col-sm-4">
                           <div class="box_main">
                     ...
                     <div class="row">
                        <div class="col-lg-4 col-sm-4">
                           <div class="box_main">
                              ...
                              <p class="price_text">Start Price <span style="color: #262626;">RM 100</span></p>
   ...
   <div class="footer_section layout_padding">
      <div class="container">
         <div class="footer_logo"><a href="index.html"><img src="images/logo_shopme-removebg-preview.png"></a></div>
         <div class="input_bt">
         ...
         <div class="location_main">Help Line Number : <a href="#">011 7001 9012</a></div>
      </div>
   </div>
   <!-- footer section end -->
